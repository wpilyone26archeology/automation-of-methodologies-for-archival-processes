...
OVERLAP   = 768   # px — increase proportionally if you change TILE_SIZE

# Detection
CONFIDENCE_MIN  = 0.15   # lowered from 0.3; rely on verification + SAM2 score instead
NMS_IOU_THRESH  = 0.40    # was 0.5 initially
